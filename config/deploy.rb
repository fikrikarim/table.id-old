...
# Remove bug Net::SSH::AuthenticationFailed: Authentication failed for user deploy@128.199.254.235
# Solution: https://stackoverflow.com/questions/41369406/netsshauthenticationfailed-authentication-failed-for-user
